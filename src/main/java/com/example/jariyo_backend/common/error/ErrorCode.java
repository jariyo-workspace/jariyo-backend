...
public enum ErrorCode {
	...
	RESERVATION_HOLD_EXPIRED("RESERVATION_HOLD_EXPIRED", HttpStatus.CONFLICT, "예약 홀드가 만료되었습니다."),
	RESERVATION_INVALID_STATE("RESERVATION_INVALID_STATE", HttpStatus.CONFLICT, "현재 예약 상태에서는 요청을 처리할 수 없습니다."),
	RESERVATION_NOT_NO_SHOW_CANDIDATE("RESERVATION_NOT_NO_SHOW_CANDIDATE", HttpStatus.CONFLICT, "노쇼 처리 가능한 예약이 아닙니다."),
	...
	STAFF_ALREADY_EXISTS("STAFF_ALREADY_EXISTS", HttpStatus.CONFLICT, "이미 매장에 등록된 사용자입니다."),
	STAFF_ALREADY_INACTIVE("STAFF_ALREADY_INACTIVE", HttpStatus.CONFLICT, "이미 비활성화된 직원입니다."),
	OWNER_CHANGE_NOT_ALLOWED("OWNER_CHANGE_NOT_ALLOWED", HttpStatus.FORBIDDEN, "다른 OWNER의 역할이나 상태를 변경할 수 없습니다."),
	LAST_ACTIVE_OWNER_REQUIRED("LAST_ACTIVE_OWNER_REQUIRED", HttpStatus.CONFLICT, "매장에는 활성 OWNER가 최소 한 명 필요합니다."),
	INVALID_STORE_SETTING("INVALID_STORE_SETTING", HttpStatus.BAD_REQUEST, "매장 설정값이 올바르지 않습니다."),
